...
http://foundation.zurb.com/docs/faq.php or use the script in the winsports
...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the winsports folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/winsports folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the winsports.info.yml.txt file to
    ...
    For example, rename the foo/winsports.info.yml.txt file to foo/foo.info.yml.
    Edit the foo.info.yml file and change "name: Foundation Sub-theme winsports"
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename winsports.libraries.yml to the name of your sub-theme, un-commenting
